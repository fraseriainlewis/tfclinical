...
```
## Quick start
This worked example is for a two arm clinical trial with binary endpoint and covers:
...
```{r out_vg1_table2, include=TRUE,echo=FALSE,out.width="100%", fig.align="center",eval=TRUE}
...
```{r out_text_image1, include=TRUE,echo=FALSE,out.width="50%", fig.align="center",eval=TRUE}
...
```{python bijectorandsteps,eval=TRUE}
...
```{r sampleout3,include=TRUE,echo=TRUE,eval=TRUE}
print(py$steps_chains)

```

```{r out_text_image2, include=TRUE,echo=FALSE,out.width="50%", fig.align="center",eval=TRUE}
knitr::include_graphics("precomputed/vg1_text3.png")
```

### No U-Turn Sampler
Now define the No U-Turn sampler, which needs several steps:
   - define the parameters in the No U-Turn sampler,
   - then wrap this inside the TransformedTransitionKernel which tell the NUTS what transformations (bijectors - as defined above) to use
...
print(current_state)
```
```{r sampleout4,include=TRUE,echo=TRUE,eval=TRUE}
print(py$current_state)

```

```{r out_text_image3, include=TRUE,echo=FALSE,out.width="50%", fig.align="center",eval=TRUE}
...
```{r sampleout5,include=TRUE,echo=TRUE,eval=TRUE}
names(py$themeans)<-c("mu0","sigma0","mu1","sigma1")
print(py$themeans)

```

```{r out_text_image4, include=TRUE,echo=FALSE,out.width="25%", fig.align="center",eval=TRUE}
...
```{r out_vg1_mcmcplots1, include=TRUE,echo=FALSE, fig.align="center",out.width="80%",eval=TRUE}
...
```{r out_vg1_mcmcplots2, include=TRUE,echo=FALSE, fig.align="center",out.width="80%",eval=TRUE}
