...
this requires a custom python venv setup to ensure correct version compatibility. See installation guide under advanced. 

This example is ported from the [original on Tensorflow GNN github site](https://colab.research.google.com/github/tensorflow/gnn/blob/master/examples/notebooks/intro_mutag_example.ipynb)
...
```{python chunkpy1,include=TRUE,echo=TRUE,eval=FALSE}
import os
...
```{python alltherest,include=FALSE,echo=TRUE,eval=FALSE}
batch_size = 32
...
knitr::include_graphics("precomputed/pyplot_loss.png")
knitr::include_graphics("precomputed/pyplot_val_loss.png")
```
