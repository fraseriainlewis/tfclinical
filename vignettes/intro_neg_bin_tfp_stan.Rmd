...
```{r stanrun,include=TRUE,echo=TRUE,eval=FALSE}
samples<-py$samples
...
```{r vg1_table2, include=TRUE,echo=FALSE, fig.align="center",eval=TRUE}
knitr::include_graphics("precomputed/vg2_plot1.png")
```

```{r stanrun1,include=TRUE,echo=TRUE,eval=FALSE}
...
```{r stanrun2,include=TRUE,echo=TRUE,eval=FALSE}
...
```{r vg2_plot23, include=TRUE,echo=FALSE, fig.align="center",eval=TRUE}
knitr::include_graphics("precomputed/vg2_plot2.png")
knitr::include_graphics("precomputed/vg2_plot3.png")
```
