---
title: "Adv (placeholder) - Basket trial"
output:
...
```{r datasets, include=TRUE,echo=TRUE,eval=FALSE}
...
```{r sampleout,include=TRUE,echo=TRUE,results='hide',eval=FALSE}
print(py$mysample)
...
```{r sampleout2,include=TRUE,echo=TRUE,results='hide',eval=FALSE}
print(py$mylogp)
