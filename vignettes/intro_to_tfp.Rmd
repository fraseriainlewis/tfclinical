---
title: "Bayesian model building walkthrough 1"
output: 
  rmarkdown::html_vignette:
    toc: true
    number_sections: true
vignette: >
  %\VignetteIndexEntry{Bayesian model building walkthrough 1}
...
```{r sampleout2,include=TRUE,echo=TRUE,eval=FALSE,results='hide'}
print(py$mylogp)

```

```{r text_image1, include=TRUE,echo=FALSE,out.width="75%", fig.align="center",eval=TRUE}
